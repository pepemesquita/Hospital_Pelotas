...
router.get('/add_doctor',function(req,res){
    db.getalldepto(function(err,result){
...
router.post('/add_doctor',upload.single("image"),function(req,res){
        ...
        db.add_doctor(req.body.pnome, req.body.snome, req.body.email, req.body.crm, req.body.data_nasc, req.body.sexo, req.body.endereco, req.body.telefone, req.file.originalname, req.body.depto_nome, req.body.bio);
    if(db.add_doctor){
    ...
    router.post('/edit_doctor/:id',function(req,res){
        var id = req.params.id;
        db.editDoc(id,req.body.pnome, req.body.snome, req.body.email,req.body.crm, req.body.data_nasc, req.body.sexo, req.body.endereco, req.body.telefone,req.body.image, req.body.depto_nome, req.body.bio,function(err,result){
            if (err) throw err;
